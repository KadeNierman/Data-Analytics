...
def calculate(list):
    ...
    variance_rows = [ls[[0, 1, 2]].var(), ls[[3, 4, 5]].var(), ls[[6, 7, 8]].var()]
    variance_columns = [ls[[0, 3, 6]].var(), ls[[1, 4, 7]].var(), ls[[2, 5, 8]].var()]

    standard_deviation_rows = [ls[[0, 1, 2]].std(), ls[[3, 4, 5]].std(), ls[[6, 7, 8]].std()]
    standard_deviation_columns = [ls[[0, 3, 6]].std(), ls[[1, 4, 7]].std(), ls[[2, 5, 8]].std()]
    ...
    return {
        ...
        'variance': [variance_columns, variance_rows, ls.var()],
        'standard deviation': [standard_deviation_columns, standard_deviation_rows, ls.std()],
